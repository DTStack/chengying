...
export HADOOP_OPTS="$HADOOP_OPTS -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.local.only=false -Dcom.sun.management.jmxremote.port=9602 -javaagent:./dtstack/prometheus/jmx_prometheus_javaagent-0.3.1.jar=9502:./dtstack/prometheus/journalnode.yml"
