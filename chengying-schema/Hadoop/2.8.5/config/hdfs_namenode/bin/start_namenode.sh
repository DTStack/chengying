...
#结合show_namenode_state.sh,重新获取服务状态
rm -f nn_state.txt

source /etc/profile

export HADOOP_OPTS="$HADOOP_OPTS -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.local.only=false -Dcom.sun.management.jmxremote.port=9609 -javaagent:./dtstack/prometheus/jmx_prometheus_javaagent-0.3.1.jar=9509:./dtstack/prometheus/namenode.yml"
