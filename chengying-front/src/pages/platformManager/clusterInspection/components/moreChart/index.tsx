...
export default function index(props: Prop) {
  ...
  const getChartData = async (params: any) => {
    ...
    const obj = {
      ...
      decimal,
      unit,
      from: new Date(moment(time[0]).format('YYYY-MM-DD 00:00:00')).valueOf(),
      to: new Date(moment(time[1]).format('YYYY-MM-DD 23:59:59')).valueOf(),
    };
    const res: any = await Api.getApplicationGraphData(obj);
    ...
    <div className="more-chart">
      ...
      <div className="more-chart-legend">
        ...
        {(chartData.y || []).map((item, index) => {
          ...
          return (
            <div className="legend-item-left" key={index}>
